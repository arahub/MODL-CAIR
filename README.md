...
```
Ghazvini, A., Hipiny, I., Ujir, H. et al. A multi-operator deep-learning approach to preserve visual integrity in content-aware image retargeting task. Sci Rep (2026). https://doi.org/10.1038/s41598-026-72081-1
```
